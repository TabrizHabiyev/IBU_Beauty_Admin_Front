...
/**
 * The base box-shadow styles for the Ibeauty Admin Dashboard PRO React.
 * You can add new box-shadow using this file.
 * You can customized the box-shadow for the entire Ibeauty Admin Dashboard PRO React using thie file.
 */
